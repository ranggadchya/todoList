...
const taskItemNode = function (taskText) {
  ...
  <button class="item-action-btn" aria-label="Remove task" data-task-remove><ion-icon name="trash-outline" aria-hidden="true"></ion-icon></button>
  `;
...
/**
 * removeTask when click on delete button ir check button
 */
const removeTask = function () {
  ...
  /**
   * if the task completed, the taskItem would be remove after 250s
...
// toggle active class on menu when click on menuBtn or dropddownLink
